...
-/
def sections := #[
  (`Analysis.Section_2_1, "Аксіоми Пеано"),
  (`Analysis.Section_2_2, "Додавання"),
  (`Analysis.Section_2_3, "Множення"),
  (`Analysis.Section_2_epilogue, "Еквівалентність натуральних чисел"),
  (`Analysis.Section_3_1, "Основи теорії множин"),
  (`Analysis.Section_3_2, "Парадок Рассела"),
  (`Analysis.Section_3_3, "Функції"),
  (`Analysis.Section_3_4, "Образи та прообрази"),
  (`Analysis.Section_3_5, "Декартов добуток"),
  (`Analysis.Section_3_6, "Потужність множин"),
  (`Analysis.Section_3_epilogue, "Зв'язки із ZFSet"),

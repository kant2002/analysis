...
/-- Визначення 1.4.12 (Sigma algebra) -/
...
/-- Вправа 1.4.13 (Intersection of sigma-algebras) -/
...
/-- Визначення 1.4.16 (Borel σ-algebra) -/
...
open Ordinal in
/-- Вправа 1.4.15 (Recursive definition of generated sigma-algebra)-/

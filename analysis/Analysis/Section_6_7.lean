...
дійсного степеня, і в епілозі до цього розділу ми покажемо, що це збігається з операцією Mathlib.
-/
...
/-- Твердження 6.7.3(a) / Вправа 6.7.1 -/
...
/-- Твердження 6.7.3(f) / Вправа 6.7.1 -/

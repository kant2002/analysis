...
/-- Твердження 4.3.3(f) / Exercise 4.3.1 -/
...
/-- Твердження 4.3.10 (Properties of exponentiation, I) / Exercise 4.3.3 -/
theorem pow_add (x:ℚ) (m n:ℕ) : x^n * x^m = x^(n+m) := by sorry

/-- Твердження 4.3.10(a) (Properties of exponentiation, I) / Exercise 4.3.3 -/
theorem pow_mul (x:ℚ) (m n:ℕ) : (x^n)^m = x^(n*m) := by sorry

/-- Твердження 4.3.10(a) (Properties of exponentiation, I) / Exercise 4.3.3 -/
theorem mul_pow (x y:ℚ) (n:ℕ) : (x*y)^n = x^n * y^n := by sorry

/-- Твердження 4.3.10(b) (Properties of exponentiation, I) / Exercise 4.3.3 -/
theorem pow_eq_zero (x:ℚ) (n:ℕ) : x^n = 0 ↔ x = 0 := by sorry

/-- Твердження 4.3.10(c) (Properties of exponentiation, I) / Exercise 4.3.3 -/
...
/-- Твердження 4.3.10(d) (Properties of exponentiation, I) / Exercise 4.3.3 -/
...
/-- Твердження 4.3.12(a) (Properties of exponentiation, II) / Exercise 4.3.4 -/
...
/-- Твердження 4.3.12(b) (Properties of exponentiation, II) / Exercise 4.3.4 -/
...
/-- Твердження 4.3.12(c) (Properties of exponentiation, II) / Exercise 4.3.4 -/
